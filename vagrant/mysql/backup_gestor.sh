...
# Havendo erros de interpretação pelo ubunto, consulte:          #
# https://terminalroot.com.br/2014/09/resolvendo-bad-interpreter #
# -no-bash.html							 #
#								 #
##################################################################
#                                                                #
...
BACKUP_DIR=/vagrant/www/gestor.dotcreative.com.br/Database
